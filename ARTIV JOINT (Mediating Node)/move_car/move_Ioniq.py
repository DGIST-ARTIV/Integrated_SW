...
class Move_Ioniq(Node):
    ...
    def move_car_callback(self, msg):
        ...
        elif mode == 4.0: #rapid deceleration
            pass
    ...
    def PID(self,desired_vel):
        ...
        self.get_logger().info(f"pid_out : {pid_out}")
        if pid_out > 1000:
            pid_out = 1000
        elif pid_out < -1000:
            pid_out = -1000
